...
export default function Hero() {
  ...
  return (
    <section className="pb-20 bg-white">
      <div className="w-full pl-[6rem] grid grid-cols-1 md:grid-cols-2 items-center">
        ...
        >
          ...
          <motion.div variants={fadeLeft}>
            <form onSubmit={handleSubmit(onSubmit)} className="flex gap-3 max-w-md mt-4">
              <input
                {...register('email')}
        ...
        <motion.div
          ...
          viewport={{ once: false, amount: 0.3 }}
          variants={fadeRight}
          className="relative w-full h-[420px] md:h-[560px] flex justify-center items-center"
        >
