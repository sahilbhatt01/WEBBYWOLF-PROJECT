...
export default function QuoteForm() {
  ...
  // small reusable icon components (outline style)
  const Icon = {
    User: () => (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M16 11c1.657 0 3-1.567 3-3.5S17.657 4 16 4s-3 1.567-3 3.5S14.343 11 16 11zM6 20v-1a4 4 0 014-4h4a4 4 0 014 4v1" />
      </svg>
    ),
    Mail: () => (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M3 8.5v7A2.5 2.5 0 005.5 18h13A2.5 2.5 0 0021 15.5v-7A2.5 2.5 0 0018.5 6h-13A2.5 2.5 0 003 8.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M21 8.5l-9 6-9-6" />
      </svg>
    ),
    Phone: () => (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M2 7.5A2.5 2.5 0 014.5 5h2a1 1 0 011 .85c.12.8.38 1.7.82 2.6.4.86 1.04 1.7 1.9 2.55.85.86 1.69 1.5 2.55 1.9.9.44 1.8.7 2.6.82a1 1 0 01.85 1v2A2.5 2.5 0 0116.5 22H7.5A2.5 2.5 0 015 19.5v-1" />
      </svg>
    ),
    Clock: () => (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M12 6v6l4 2" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M12 4a8 8 0 100 16 8 8 0 000-16z" />
      </svg>
    ),
    Ruler: () => (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path strokeLinejoin="round" strokeWidth="1.75" strokeLinecap="round" d="M3 21l18-18M7 7h.01M11 11h.01M15 15h.01M19 19h.01" />
      </svg>
    ),
    Hash: () => (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M7 4v16M17 4v16M3 10h18M3 14h18" />
      </svg>
    ),
    Pencil: () => (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M15.232 5.232l3.536 3.536M4 20l7.586-1.172 9.9-9.9a2.828 2.828 0 00-4-4l-9.9 9.9L4 20z" />
      </svg>
    ),
    ArrowRight: () => (
      <svg className="inline-block w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" d="M5 12h14M13 5l7 7-7 7" />
      </svg>
    ),
  };
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative">
            ...
            <select
              ...
              aria-label="Quantity"
            >
              <option value="" disabled hidden>Choose Quantity</option>
