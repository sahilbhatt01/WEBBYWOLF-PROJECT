            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-10 items-center">
                ...
                >
                    ...
                    >
                        ...
                        leo eleifend commodo in vitae sit amet. Amet massa malesuada est
                    ...
                    >
                        <li className="flex gap-3 items-start">
                            <Image src="/icon/icon.png" width={28} height={28} alt="" className="mt-1" />
                            <p className="text-gray-700">
                                <strong>Lorem ipsum dolor sit amet consectetur. Volutpat hac morbi egestas.</strong><br />
                                Lorem ipsum dolor sit amet consectetur. Eros egestas et arcu eu non viverra.
                                Risus quam mattis consectetur vitae interdum magna et ornare gravida
                                vestibulum. Donec turpis nulla felis mauris eu libero. Ipsum ut tortor.
                            </p>
                        </li>
                        ...
                        <li className="flex gap-3 items-start">
                            <Image src="/icon/icon.png" width={28} height={28} alt="" className="mt-1" />
                            <p className="text-gray-700">
                                <strong>Lorem ipsum dolor sit amet consectetur. Eros egestas et arcu eu non viverra.</strong><br />
                                Lorem ipsum dolor sit amet consectetur. Eros egestas et arcu eu non viverra.
                                Risus quam mattis consectetur vitae interdum magna et ornare gravida
                                vestibulum. Donec turpis nulla felis mauris eu libero. Ipsum ut tortor.
                            </p>
